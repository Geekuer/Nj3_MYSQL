...
module.exports = {
	...
	page: function (request, response) {
		...
		db.query(`SELECT * FROM topic`, function (error, topics) {
			...
			db.query(`SELECT topic.id, title, description, created, name, profile FROM topic LEFT JOIN author ON topic.author_id=author.id WHERE topic.id=?`, [query.id], function (error2, topic) {
				if (error2) {
					throw error2;
				}
	...
	update: function (request, response) {
		...
		db.query(`SELECT * FROM topic`, function (error, topics) {
			...
			db.query(`SELECT * FROM topic WHERE id=?`, [query.id], function (error2, topic) {
				if (error2) {
					throw error2;
				}
